...
BOOST_FUSION_DEFINE_STRUCT ((shared_class), CreateGameLobby, )
BOOST_FUSION_DEFINE_STRUCT ((shared_class), CreateGameLobbySuccess, )
BOOST_FUSION_DEFINE_STRUCT ((shared_class), CreateGameLobbyError, )
